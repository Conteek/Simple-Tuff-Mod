...
import net.conteek.simpletuff.init.SimpleTuffModTabs;
...
@Mod("simple_tuff")
public class SimpleTuffMod {
	public static final Logger LOGGER = LogManager.getLogger(SimpleTuffMod.class);
	public static final String MODID = "simple_tuff";

	public SimpleTuffMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		SimpleTuffModSounds.REGISTRY.register(bus);
		SimpleTuffModBlocks.REGISTRY.register(bus);

		SimpleTuffModItems.REGISTRY.register(bus);

		SimpleTuffModTabs.REGISTRY.register(bus);
